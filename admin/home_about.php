                     ...
                     <div class="card d-flex flex-row mb-3 element-to-hide">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">URL</p>
                                <!--<p class="mb-0 text-muted text-small w-15 w-sm-100">Type</p>-->
                    ...
                    <div class="card d-flex flex-row mb-3">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><?php echo $row['sub_heading']?></p>
