<?php
   ...
   $title = 'ALL COUNTRIES WE OFFER';
   $table = 'all_services_countries';
   $manage_page = 'all_manage_services_countries.php';
            ...
            <div class="row">
                     ...
                     <div class="card d-flex flex-row mb-3 element-to-hide">
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Procedure</p>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100">Agreement</p>
                ...
                <?php while($row=mysqli_fetch_assoc($res)){ ?>
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="<?php echo MANAGE_WHY_IMAGE_SERVER_PATH.$row['image']?>" target="_blank">
                            <img src="<?php echo '../media/allSearvices/'.$row['image']?>" alt="<?php echo $row['heading']?>"
                                class="list-thumbnail responsive border-0 card-img-left img-size-fixed" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                                ...
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><a href="../media/allSearvices/<?php echo $row['procedure_pdf']; ?>" target="_blank">Procedure (PDF)</a></p>
                                <p class="mb-0 text-muted text-small w-15 w-sm-100"><a href="../media/allSearvices/<?php echo $row['agreement_pdf']; ?>" target="_blank">Agreement (PDF)</a></p>
