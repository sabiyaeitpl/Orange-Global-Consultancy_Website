<?php
   ...
   $table = 'contents';
   $section_title = 'Home Content Section';
    ...
    if(isset($_POST['submit'])){
        ...
        if($msg==''){
            ...
            if($_FILES['image']['name']!=''){
                    ...
                    mysqli_query($con,"update $table set heading='$heading',sub_heading='$sub_heading',content='$content',type='$type',image='$image' where id='$id'");
                }
                else{
                    mysqli_query($con,"update $table set heading='$heading',sub_heading='$sub_heading',content='$content',type='$type' where id='$id'");
                }
                ...
                mysqli_query($con,"insert into $table(heading,sub_heading,content,image,type,status) values('$heading','$sub_heading','$content','$image','$type','1')");
            }
        //	header('location:banner.php');
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="needs-validation tooltip-label-right" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="" name="sub_heading" value="<?php echo $sub_heading?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="" name="type" value="<?php echo $type; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
