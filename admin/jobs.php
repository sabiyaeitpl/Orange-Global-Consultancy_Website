                                ...
                                <tbody>
                                    ...
                                    if($count > 0){
                                     ...
                                     <tr>
                                            ...
                                            <td><img class="img-fluid" style="height:75px; width:70px;" src="../assets/img/<?php echo $row['job_image']; ?>" /></td>
                                            <td><a href="../assets/procedure/<?php echo $row['procedure_dtl']; ?>" target="_blank">Show</a></td>
                                            <td><a href="../assets/agreement/<?php echo $row['agreement']; ?>" target="_blank">Show</a></td>
                                            <td>
                                               <?php 
                                               if($row['job_status']==1){
