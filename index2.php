...
<style>
  p{
    ...
    .carousel-item img {
        height: 100%; /* Make the image fill the entire height of the carousel */
        width: auto; /* Maintain the aspect ratio */
        object-fit: cover; /* Ensure the image covers the entire area of the carousel */
    }

    .carousel-item {
        position: relative; /* Ensure the carousel items are positioned relatively */
    }
    ...
    .carousel-link {
        ...
        z-index: 999; /* Ensure links appear above the image */
    }
    ...
    .carousel-button {
        ...
        z-index: 999; /* Ensure buttons appear above the image */
    }
</style>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <a href="#"><img class="d-block w-100" src="assets/img/avliblejob/image1.jpeg" alt="First slide"></a>
            
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/avliblejob/image2.jpeg" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/avliblejob/image3.jpeg" alt="Third slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/avliblejob/image4.jpeg" alt="Fourth slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/avliblejob/image5.jpeg" alt="Fifth slide">
        </div>
    </div>
